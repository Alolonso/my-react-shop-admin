            ...
            <div className="relative flex h-16 items-center justify-between">
              ...
              <div className="flex flex-1 items-center justify-center sm:items-stretch sm:justify-start">
                <div className="flex flex-shrink-0 items-center">
                  <Image className="h-8 w-auto" src="https://alolonso.github.io/cv-database/src/icons/logo.svg" alt="Your Company" width={200} height={200} />
                  {/* <img className="h-8 w-auto" src="https://alolonso.github.io/cv-database/src/icons/logo.svg" alt="Your Company" /> */}
                </div>
                ...
                <Menu as="div" className="relative ml-3">
                  <div>
                    <Menu.Button className="relative flex rounded-full bg-gray-800 text-sm focus:outline-none focus:ring-2 focus:ring-white focus:ring-offset-2 focus:ring-offset-gray-800">
                      ...
                      <img className="h-8 w-8 rounded-full" src={user ? `https://ui-avatars.com/api/?name=${user.name}` : `https://ui-avatars.com/api/?name=`} alt="" />
                    </Menu.Button>
                  </div>
                  <Transition
                    as={Fragment}
                  ...
                  >
                    <Menu.Items className="absolute right-0 z-10 mt-2 w-48 origin-top-right rounded-md bg-white py-1 shadow-lg ring-1 ring-black ring-opacity-5 focus:outline-none">
                      <Menu.Item>
                        {({ active }) => (
                          <a href="/dashboard" className={classNames(active ? 'bg-gray-100' : '', 'block px-4 py-2 text-sm text-gray-700')}>
                            Your Profile
                          </a>
                        )}
                      </Menu.Item>
